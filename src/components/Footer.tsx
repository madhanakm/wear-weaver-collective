...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-secondary via-secondary/98 to-secondary text-secondary-foreground overflow-hidden rounded-t-[5rem]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-16">
          ...
          <div className="space-y-7 lg:col-span-1">
            ...
            <div className="flex gap-3 pt-3">
              <a href="https://www.youtube.com/@nisanthapparels?si=1pJMeGwTTgHqqh6A" target="_blank" rel="noopener noreferrer" className="relative w-10 h-10 rounded-full bg-gradient-to-br from-secondary-foreground/10 to-secondary-foreground/5 hover:from-red-500/25 hover:to-red-600/25 flex items-center justify-center transition-all duration-500 hover:scale-110 hover:-translate-y-2 border border-secondary-foreground/10 hover:border-red-500/40 group shadow-lg hover:shadow-2xl">
                <span className="absolute inset-0 rounded-full bg-gradient-to-br from-red-500/0 to-red-600/0 group-hover:from-red-500/20 group-hover:to-red-600/20 blur transition-all duration-500"></span>
                <svg className="relative z-10 w-4 h-4 group-hover:text-red-500 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href="https://www.instagram.com/nisanth_apparels?igsh=MTJiajkwaGQxdnA2cQ%3D%3D" target="_blank" rel="noopener noreferrer" className="relative w-10 h-10 rounded-full bg-gradient-to-br from-secondary-foreground/10 to-secondary-foreground/5 hover:from-pink-500/25 hover:to-purple-500/25 flex items-center justify-center transition-all duration-500 hover:scale-110 hover:-translate-y-2 border border-secondary-foreground/10 hover:border-pink-500/40 group shadow-lg hover:shadow-2xl">
                <span className="absolute inset-0 rounded-full bg-gradient-to-br from-pink-500/0 to-purple-500/0 group-hover:from-pink-500/20 group-hover:to-purple-500/20 blur transition-all duration-500"></span>
              ...
              <a href="https://www.facebook.com/share/1CKY7Ubf58/" target="_blank" rel="noopener noreferrer" className="relative w-10 h-10 rounded-full bg-gradient-to-br from-secondary-foreground/10 to-secondary-foreground/5 hover:from-blue-500/25 hover:to-blue-600/25 flex items-center justify-center transition-all duration-500 hover:scale-110 hover:-translate-y-2 border border-secondary-foreground/10 hover:border-blue-500/40 group shadow-lg hover:shadow-2xl">
                <span className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-500/0 to-blue-600/0 group-hover:from-blue-500/20 group-hover:to-blue-600/20 blur transition-all duration-500"></span>
                <svg className="relative z-10 w-4 h-4 group-hover:text-blue-500 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
              </a>
            </div>
          </div>
