    ...
    <div class="main-content">
        ...
        try {
            ...
            if ($viewId && $page === 'contacts') {
                ...
                echo "  fetch('$API_URL/blog-api.php?path=delete/' + id, { method: 'DELETE' })";
                ...
                echo "  fetch('$API_URL/testimonials-api.php?path=delete/' + id, { method: 'DELETE' })";
                ...
                if ($viewGallery) {
                    ...
                    echo "  fetch('$API_URL/products-api.php?path=delete-gallery/' + id, { method: 'DELETE' })";
                    echo "    .then(() => location.reload());";
                    echo "}";
                    echo "</script>";
                ...
                echo "  fetch('$API_URL/sliders-api.php?path=admin')";
                echo "    .then(r => r.json())";
                echo "    .then(data => {";
                ...
                echo "          imageUrl = '$API_URL/' + imageUrl;";
                echo "        }";
                echo "        if (imageUrl) {";
                ...
                echo "  fetch('$API_URL/sliders-api.php?path=delete/' + id, { method: 'DELETE' })";
                echo "    .then(() => location.reload());";
                echo "}";
                ...
                echo "  const url = id ? '$API_URL/sliders-api.php?path=update/' + id : '$API_URL/sliders-api.php?path=create';";
                echo "  const method = id ? 'PUT' : 'POST';";
